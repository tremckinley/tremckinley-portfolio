            ...
            <div className=" flex flex-col lg:flex-row items-center lg:justify-start w-full">
                <div className="flex flex-col lg:flex-row-reverse items-center">
                    ...
                    <div className="flex lg:flex-col lg:items-end lg:pr-2 justify-between w-24 lg:text-3xl text-xl">
                        <a href="https://www.linkedin.com/in/tremaine-mckinley/" target="_blank"><i className="hover:text-[teal] active:text-white fa-brands fa-linkedin" title="Visit LinkedIn page"></i></a>
                        ...
                        >
                            <i className="fa fa-envelope hover:text-[teal] active:text-white"></i>
                        </button>
                        <a href="https://github.com/tremckinley" target="_blank" title="Visit my GitHub Profile"><i className="fa-brands fa-github hover:text-[teal] active:text-white"></i></a>
                    </div>
                </div>
                <div className="lg:ml-4 text-center lg:text-left">
                    ...
                    <h3 className="mt-2 ml-2 text-md lg:text-2xl font-semibold text-[teal]">Let's get to it.</h3>
                </div>
            </div>
