export default function AboutSection() {
    return (
        <section className="my-4 p-5 bg-gray-50 border border-neutral-500 rounded-lg -bio-background shadow-sm shadow-gray-400 mb-10">
        ...
        <br/><br/>
        <center><strong>Let’s connect! I’m sure there's something great we can do together.</strong></center>
        </p>
